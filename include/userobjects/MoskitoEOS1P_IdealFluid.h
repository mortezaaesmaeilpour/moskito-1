...
class MoskitoEOS1P_IdealFluid;

template <>
InputParameters validParams<MoskitoEOS1P_IdealFluid>();

class MoskitoEOS1P_IdealFluid : public MoskitoEOS1P
{
public:
  MoskitoEOS1P_IdealFluid(const InputParameters & parameters);
