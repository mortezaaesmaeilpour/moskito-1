...
#ifndef MOSKITOMASSSIMPLE_H
#define MOSKITOMASSSIMPLE_H

#include "Kernel.h"

class MoskitoMassSimple;

template <>
InputParameters validParams<MoskitoMassSimple>();

class MoskitoMassSimple : public Kernel
{
public:
  MoskitoMassSimple(const InputParameters & parameters);
