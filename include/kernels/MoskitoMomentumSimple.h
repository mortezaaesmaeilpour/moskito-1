...
#ifndef MOSKITOMOMENTUMSIMPLE_H
#define MOSKITOMOMENTUMSIMPLE_H

#include "Kernel.h"

class MoskitoMomentumSimple;

template <>
InputParameters validParams<MoskitoMomentumSimple>();

class MoskitoMomentumSimple : public Kernel
{
public:
  MoskitoMomentumSimple(const InputParameters & parameters);
