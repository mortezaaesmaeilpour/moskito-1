...
registerMooseObject("MoskitoApp", MoskitoWater97FluidProperties);
...
MoskitoWater97FluidProperties::~MoskitoWater97FluidProperties() {}

std::string
MoskitoWater97FluidProperties::fluidName() const
{
  return "water";
}

Real
MoskitoWater97FluidProperties::molarMass() const
{
  return _Mh2o;
}

Real
MoskitoWater97FluidProperties::criticalPressure() const
{
  return _p_critical;
}

Real
MoskitoWater97FluidProperties::criticalTemperature() const
{
  return _T_critical;
}

Real
MoskitoWater97FluidProperties::criticalDensity() const
{
  return _rho_critical;
}

Real
MoskitoWater97FluidProperties::triplePointPressure() const
{
  return _p_triple;
}

Real
MoskitoWater97FluidProperties::triplePointTemperature() const
{
  return _T_triple;
}

Real
MoskitoWater97FluidProperties::rho_from_p_T(Real pressure, Real temperature) const
{
  Real density, pi, tau;
...
Real
MoskitoWater97FluidProperties::e_from_p_T(Real pressure, Real temperature) const
{
...
void
MoskitoWater97FluidProperties::e_from_p_T(
...
void
MoskitoWater97FluidProperties::rho_e_dpT(Real pressure,
                                  Real temperature,
                                  Real & rho,
                                  Real & drho_dp,
                                  Real & drho_dT,
...
Real
MoskitoWater97FluidProperties::c_from_p_T(Real pressure, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::cp_from_p_T(Real pressure, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::mu_from_p_T(Real pressure, Real temperature) const
{
...
void
MoskitoWater97FluidProperties::mu_from_p_T(
...
Real
MoskitoWater97FluidProperties::mu_from_rho_T(Real density, Real temperature) const
{
  Real mu_star = 1.e-6;
...
void
MoskitoWater97FluidProperties::mu_drhoT_from_rho_T(Real density,
                                            Real temperature,
                                            Real ddensity_dT,
                                            Real & mu,
                                            Real & dmu_drho,
...
void
MoskitoWater97FluidProperties::rho_mu(Real pressure, Real temperature, Real & rho, Real & mu) const
{
  rho = this->rho_from_p_T(pressure, temperature);
...
void
MoskitoWater97FluidProperties::rho_mu_dpT(Real pressure,
                                   Real temperature,
                                   Real & rho,
                                   Real & drho_dp,
                                   Real & drho_dT,
...
Real
MoskitoWater97FluidProperties::k_from_p_T(Real pressure, Real temperature) const
{
  Real rho = this->rho_from_p_T(pressure, temperature);
...
void
MoskitoWater97FluidProperties::k_from_p_T(
...
Real
MoskitoWater97FluidProperties::k_from_rho_T(Real density, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::s_from_p_T(Real pressure, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::h_from_p_T(Real pressure, Real temperature) const
{
...
void
MoskitoWater97FluidProperties::vaporPressure_dT(Real temperature, Real & psat, Real & dpsat_dT) const
{
  // Check whether the input temperature is within the region of validity of this equation.
  // Valid for 273.15 K <= t <= 647.096 K
  if (temperature < 273.15 || temperature > _T_critical)
...
Real
MoskitoWater97FluidProperties::vaporTemperature(Real pressure) const
{
...
Real
MoskitoWater97FluidProperties::b23p(Real temperature) const
{
  // Check whether the input temperature is within the region of validity of this equation.
...
Real
MoskitoWater97FluidProperties::b23T(Real pressure) const
{
  // Check whether the input pressure is within the region of validity of this equation.
...
unsigned int
MoskitoWater97FluidProperties::inRegion(Real pressure, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::gamma1(Real pi, Real tau) const
{
  Real sum = 0.0;
...
Real
MoskitoWater97FluidProperties::dgamma1_dpi(Real pi, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 0; i < _n1.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma1_dpi2(Real pi, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 0; i < _n1.size(); ++i)
...
Real
MoskitoWater97FluidProperties::dgamma1_dtau(Real pi, Real tau) const
{
  Real g = 0.0;
  for (std::size_t i = 0; i < _n1.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma1_dtau2(Real pi, Real tau) const
{
  Real dg = 0.0;
  for (std::size_t i = 0; i < _n1.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma1_dpitau(Real pi, Real tau) const
{
  Real dg = 0.0;
  for (std::size_t i = 0; i < _n1.size(); ++i)
...
Real
MoskitoWater97FluidProperties::gamma2(Real pi, Real tau) const
{
...
Real
MoskitoWater97FluidProperties::dgamma2_dpi(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 1.0 / pi;
...
Real
MoskitoWater97FluidProperties::d2gamma2_dpi2(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = -1.0 / pi / pi;
...
Real
MoskitoWater97FluidProperties::dgamma2_dtau(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
  for (std::size_t i = 0; i < _n02.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma2_dtau2(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
  for (std::size_t i = 0; i < _n02.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma2_dpitau(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
...
Real
MoskitoWater97FluidProperties::phi3(Real delta, Real tau) const
{
  Real sum = 0.0;
...
Real
MoskitoWater97FluidProperties::dphi3_ddelta(Real delta, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 1; i < _n3.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2phi3_ddelta2(Real delta, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 1; i < _n3.size(); ++i)
...
Real
MoskitoWater97FluidProperties::dphi3_dtau(Real delta, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 1; i < _n3.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2phi3_dtau2(Real delta, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 1; i < _n3.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2phi3_ddeltatau(Real delta, Real tau) const
{
  Real sum = 0.0;
  for (std::size_t i = 1; i < _n3.size(); ++i)
...
Real
MoskitoWater97FluidProperties::gamma5(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real sum0 = 0.0;
...
Real
MoskitoWater97FluidProperties::dgamma5_dpi(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 1.0 / pi;
...
Real
MoskitoWater97FluidProperties::d2gamma5_dpi2(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = -1.0 / pi / pi;
...
Real
MoskitoWater97FluidProperties::dgamma5_dtau(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
  for (std::size_t i = 0; i < _n05.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma5_dtau2(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
  for (std::size_t i = 0; i < _n05.size(); ++i)
...
Real
MoskitoWater97FluidProperties::d2gamma5_dpitau(Real pi, Real tau) const
{
  // Ideal gas part of the Gibbs free energy
  Real dg0 = 0.0;
...
unsigned int
MoskitoWater97FluidProperties::subregion3(Real pressure, Real temperature) const
{
...
Real
MoskitoWater97FluidProperties::tempXY(Real pressure, subregionEnum xy) const
{
...
Real
MoskitoWater97FluidProperties::subregionVolume(
...
Real
MoskitoWater97FluidProperties::densityRegion3(Real pressure, Real temperature) const
{
...
unsigned int
MoskitoWater97FluidProperties::inRegionPH(Real pressure, Real enthalpy) const
{
  unsigned int region;
...
unsigned int
MoskitoWater97FluidProperties::subregion2ph(Real pressure, Real enthalpy) const
{
...
unsigned int
MoskitoWater97FluidProperties::subregion3ph(Real pressure, Real enthalpy) const
{
  unsigned int subregion;
...
Real
MoskitoWater97FluidProperties::b2bc(Real pressure) const
{
  // Check whether the input pressure is within the region of validity of this equation.
...
Real
MoskitoWater97FluidProperties::temperature_from_ph(Real pressure, Real enthalpy) const
{
...
Real
MoskitoWater97FluidProperties::temperature_from_ph1(Real pressure, Real enthalpy) const
{
  Real pi = pressure / 1.0e6;
...
Real
MoskitoWater97FluidProperties::temperature_from_ph2a(Real pressure, Real enthalpy) const
{
  Real pi = pressure / 1.0e6;
...
Real
MoskitoWater97FluidProperties::temperature_from_ph2b(Real pressure, Real enthalpy) const
{
  Real pi = pressure / 1.0e6;
  Real eta = enthalpy / 2000.0e3;
  Real sum = 0.0;
...
Real
MoskitoWater97FluidProperties::temperature_from_ph2c(Real pressure, Real enthalpy) const
{
  Real pi = pressure / 1.0e6;
  Real eta = enthalpy / 2000.0e3;
  Real sum = 0.0;
...
Real
MoskitoWater97FluidProperties::b3ab(Real pressure) const
{
  // Check whether the input pressure is within the region of validity of this equation.
...
Real
MoskitoWater97FluidProperties::temperature_from_ph3a(Real pressure, Real enthalpy) const
{
...
Real
MoskitoWater97FluidProperties::temperature_from_ph3b(Real pressure, Real enthalpy) const
{
  Real pi = pressure / 100.0e6;
