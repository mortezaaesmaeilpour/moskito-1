...
#include "MoskitoViscosityConst.h"

registerMooseObject("MoskitoApp", MoskitoViscosityConst);
...
Real MoskitoViscosityConst::mu(Real /* pressure */, Real /* temperature */) const { return _mu0; }

void
MoskitoViscosityConst::dmu_dpT(
